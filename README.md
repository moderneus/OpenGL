...
- Secondly we need a window themself. To got it we should use *SDL_CreateWindow()* function with relevant arguments.
  
- After we wanna be able to handle any events, such as *SDL_EVENT_QUIT*, *SDL_EVENT_WINDOW_MOVED*, *SDL_EVENT_WINDOW_RESIZED*, etc. 
